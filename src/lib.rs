...
pub use embeddenator_vsa::{SparseVec, SparsityScaling, VsaConfig, VsaConfigSchema, DIM};
...
#[cfg(feature = "realworld-datasets")]
pub use datasets::{DatasetCatalog, DatasetCategory, DatasetManager, DatasetTier};
